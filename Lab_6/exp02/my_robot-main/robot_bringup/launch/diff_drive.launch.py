...
def generate_launch_description():
    ...
    robot_walking = Node(
    	package= 'robot_walking',
    	executable= 'robot_walking',
    	name= 'robot_walking',
    	output='screen'
    )
    
    forward_walking = Node(
    	package= 'robot_walking',
    	executable= 'forward_walking',
    	name= 'forward_walking',
    	output='screen'
    )
    
    unique_robot_walking = Node(
    	package= 'robot_walking',
    	executable= 'unique_robot_walking',
    	name= 'unique_robot_walking',
    	output='screen'
    )
    
    depth_robot_walking = Node(
    	package= 'robot_walking',
    	executable= 'depth_robot_walking',
    	name= 'depth_robot_walking',
    	output='screen'
    )
